...
namespace TVControl.App.Simulation
{
    public class TvControlSimulationComponent : SimComponent
    {
        ...
        /// <summary>
        /// Статистика по количеству пройденных настроек
        /// </summary>
        public SimpleStatistics AdjustmentCountStatistics;
        ...
        protected override void Init()
        {
            ...
            AdjustmentCountStatistics = new SimpleStatistics("Количество настроек успешно принятых телевизоров");
        }
